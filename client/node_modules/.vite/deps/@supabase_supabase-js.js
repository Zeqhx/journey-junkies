...
var resolveFetch = (customFetch) => {
  ...
  if (customFetch) {
    ...
    _fetch = (...args) => __awaiter(void 0, void 0, void 0, function* () {
      return yield (yield import("./browser-ponyfill-EYJHTV7Y.js")).fetch(...args);
    });
  } else {
    _fetch = fetch;
  }
...
var resolveResponse = () => __awaiter5(void 0, void 0, void 0, function* () {
  if (typeof Response === "undefined") {
    return (yield import("./browser-ponyfill-EYJHTV7Y.js")).Response;
  }
  return Response;
});
...
var GoTrueClient = class {
  ...
  constructor(options) {
    ...
    if (isBrowser() && globalThis.BroadcastChannel && this.persistSession && this.storageKey) {
      ...
      (_a = this.broadcastChannel) === null || _a === void 0 ? void 0 : _a.addEventListener("message", (event) => __awaiter13(this, void 0, void 0, function* () {
  ...
  _notifyAllSubscribers(event, session, broadcast = true) {
    return __awaiter13(this, void 0, void 0, function* () {
      ...
      const errors = [];
      const promises = Array.from(this.stateChangeEmitters.values()).map((x) => __awaiter13(this, void 0, void 0, function* () {
        try {
