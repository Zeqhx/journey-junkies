...
function ConfirmModal({
  ...
  return import_react3.default.createElement(import_react3.default.Fragment, null, children && import_react3.default.createElement(Box, {
    mb: "md"
  }, children), import_react3.default.createElement(Group, __spreadValues({
    position: "right"
  }, groupProps), import_react3.default.createElement(Button, __spreadProps(__spreadValues({
    variant: "default"
  }, cancelProps), {
    onClick: handleCancel
  }), (cancelProps == null ? void 0 : cancelProps.children) || cancelLabel), import_react3.default.createElement(Button, __spreadProps(__spreadValues({}, confirmProps), {
...
function ModalsProvider({ children, modalProps, labels, modals: modals2 }) {
  ...
  const closeAll = (0, import_react4.useCallback)((canceled) => {
    dispatch({ type: "CLOSE_ALL", canceled });
  }, [stateRef, dispatch]);
  const openModal2 = (0, import_react4.useCallback)((_a) => {
  ...
  const openConfirmModal2 = (0, import_react4.useCallback)((_c) => {
  ...
  const openContextModal2 = (0, import_react4.useCallback)((modal, _e) => {
  ...
  const closeModal2 = (0, import_react4.useCallback)((id, canceled) => {
  ...
  const getCurrentModal = () => {
    ...
    switch (currentModal == null ? void 0 : currentModal.type) {
      case "context": {
        ...
        return {
          modalProps: rest,
          content: import_react4.default.createElement(ContextModal, {
            innerProps,
            context: ctx,
            id: currentModal.id
          })
      ...
      case "confirm": {
        ...
        return {
          ...
          content: import_react4.default.createElement(ConfirmModal, __spreadProps2(__spreadValues2({}, separatedConfirmProps), {
            id: currentModal.id,
  ...
  return import_react4.default.createElement(ModalsContext.Provider, {
    value: ctx
  }, import_react4.default.createElement(Modal, __spreadProps2(__spreadValues2(__spreadValues2({
